...
# and set proper ENV ROSIE_MOUNT_PATH and ROSIE_CONSIDER_HTTPS_PROTOCOL variables
...
WebConsole::Request.class_eval do
  def from_whitelisted_ip?;
    ...
    return programmer_authenticated && (ssl? || local? || (ENV['ROSIE_CONSIDER_HTTPS_PROTOCOL']=='true'))
  end
